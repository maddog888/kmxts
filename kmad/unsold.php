<?php
    ...
    if(isset($_POST['dd']) and $_POST['dd']){
        ...
        if(isset($_GET['spid']) and $_GET['spid']){
            ...
            if($de){
                echo '<script language="javascript">alert("清空已销售卡密完毕");</script>';
            }else{
                echo '<script language="javascript">alert("清空已销售卡密失败,请再试一次看看吧！");</script>';
            }
        }
    }
    ...
    foreach($kms as $km){
        ...
        <tr>
            ...
            <td>'.$km['dh'].'</td>
            <td>'.$km['mode'].'</td>
            <td>'.date('Y-m-d H:i:s',$km['time']).'</td>
            <td>'.$pwd['pwd'].'</td>
        </tr>
        ';
    }
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 已售卡密管理 
                    </div>
                </div>
                <form method="post">
                    <div class="tpl-block">
                                ...
                                <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-dh">支付单号</th>
                                            <th class="table-mode">支付方式</th>
                                            <th class="table-time">支付时间</th>
                                            <th class="table-pwd">客户联系方式</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
